...
snakemake --drmaa " --time=72:00:00 --partition=medium --mem=160000 --mem-per-cpu=15048 --ntasks-per-node=5" -r --nt --jobs 2 --use-conda -p --rerun-incomplete --conda-prefix=/fast/users/altwassr_c/work/conda-envs/
